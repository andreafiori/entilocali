...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": attiva per ordinare le colonne in modo ascendente",sSortDescending:": attiva per ordinare le colonne in modo discendente"},oPaginate:{sFirst:"Primo",sLast:"Ultimo",sNext:"Successivo",sPrevious:"Precedente"},sEmptyTable:"Nessun dato disponibile",sInfo:"Records _START_ su _END_ di _TOTAL_ inseriti",sInfoEmpty:"Records 0 da 0 su 0 inseriti",sInfoFiltered:"(filtra da _MAX_ in totale)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"Mostra _MENU_ inseriti",sLoadingRecords:"Caricamento...",sProcessing:"Attendere...",sSearch:"Cerca:",sUrl:"",sZeroRecords:"Nessun risultato trovato"},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};S(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,bSortable:!0,bVisible:!0,fnCreatedCell:null,
