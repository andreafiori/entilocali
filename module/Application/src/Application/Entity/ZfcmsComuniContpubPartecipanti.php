...
/**
 * ZfcmsComuniContpubPartecipanti
 *
 * @ORM\Table(name="zfcms_comuni_contpub_partecipanti")
 * @ORM\Entity
 */
class ZfcmsComuniContpubPartecipanti
{
    /**
     * @var integer
     *
     ...
     * @param string $cf
     *
     * @return ZfcmsComuniContpubPartecipanti
     */
