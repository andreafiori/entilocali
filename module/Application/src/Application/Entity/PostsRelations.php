 ...
 * PostsRelations
 *
 * @ORM\Table(name="posts_relations", indexes={@ORM\Index(name="channel_id", columns={"channel_id"}), @ORM\Index(name="module_id", columns={"module_id"}), @ORM\Index(name="category_id", columns={"category_id"}), @ORM\Index(name="posts_id", columns={"posts_id"})})
 * @ORM\Entity
 */
