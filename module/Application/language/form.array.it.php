...
return array(
    ...
    "The input is an empty string" => "L'input &egrave; una stringa vuota",
    ...
    "The country provided is currently unsupported" => "La nazionalità fornita non &egrave; correntemente supportata",
    "Invalid type given. String expected" => "Tipo di dato non valido. Era attesto un dato di tipo string",

    // Zend\I18n\Validator\PostCode
    "Invalid type given. String or integer expected" => "Tipo di dato non valido. Era atteso un dato di tipo string o integer",
    "The input does not appear to be a postal code" => "L'input non sembra essere un codice postale",
    "An exception has been raised while validating the input" => "Un'eccezione &egrave; stata sollevada durante la validazione dell'input",
    ...
    "The input is not between '%min%' and '%max%', inclusively" => "L'input non &egrave; compreso tra '%min%' e '%max%', inclusi",
    "The input is not strictly between '%min%' and '%max%'" => "L'input non &egrave; strettamente compreso tra '%min%' e '%max%'",

    // Zend\Validator\Callback
    "The input is not valid" => "L'input non &egrave; valido",
    "An exception has been raised within the callback" => "Un'eccezione &egrave; stata sollevata all'interno della callback",
    ...
    // Zend\Validator\Csrf
    "The form submitted did not originate from the expected site" => "Il form inviato non ha avuto origine dal luogo previsto",
    ...
    "The input is not a valid step" => "L'input non &egrave; uno step valido",

    // Zend\Validator\Db\AbstractDb
    "No record matching the input was found" => "Non &egrave; stata trovata nessuna riga corrispondente all'input",
    ...
    "Invalid type given. String expected" => "Tipo di dato non valido. Era attesto un dato di tipo string",
    "The input is not a valid email address. Use the basic format local-part@hostname" => "L'input non &egrave; un indirizzo email valido nel formato base local-part@hostname",
    "'%hostname%' is not a valid hostname for the email address" => "'%hostname%' non &egrave; un hostname valido nell'indirizzo email",
    ...
    "'%hostname%' is not in a routable network segment. The email address should not be resolved from public network" => "'%hostname%' non &egrave; in un segmento di rete instradabile. L'indirizzo email non può essere risolto nella rete pubblica",
    ...
    "'%localPart%' is not a valid local part for the email address" => "'%localPart%' non &egrave; una local part valida nell'indirizzo email",
    ...
    "File is not readable or does not exist" => "Il file non &egrave; leggibile o non esiste",
    ...
    "All files in sum should have a maximum size of '%max%' but '%size%' were detected" => "I file devono avere in totale una dimensione massima di '%max%' ma &egrave; stata rilevata una dimensione di '%size%'",
    "All files in sum should have a minimum size of '%min%' but '%size%' were detected" => "I file devono avere in totale una dimensione minima di '%min%' ma &egrave; stata rilevata una dimensione di '%size%'",
    "One or more files can not be read" => "Uno o pi&ugrave; file non possono essere letti",
    ...
    "Maximum allowed width for image should be '%maxwidth%' but '%width%' detected" => "La larghezza massima consentita per l'immagine &egrave; '%maxwidth%' ma &egrave; stata rilevata una larghezza di '%width%'",
    "Minimum expected width for image should be '%minwidth%' but '%width%' detected" => "La larghezza minima consentita per l'immagine &egrave; '%minwidth%' ma &egrave; stata rilevata una larghezza di '%width%'",
    "Maximum allowed height for image should be '%maxheight%' but '%height%' detected" => "L'altezza massima consentita per l'immagine &egrave; '%maxheight%' ma &egrave; stata rilevata un'altezza di '%height%'",
    "Minimum expected height for image should be '%minheight%' but '%height%' detected" => "L'altezza minima consentita per l'immagine &egrave; '%minheight%' ma &egrave; stata rilevata un'altezza di '%height%'",
    "The size of image could not be detected" => "Le dimensioni dell'immagine non possono essere rilevate",
    "File is not readable or does not exist" => "Il file non &egrave; leggibile o non esiste",

    // Zend\Validator\File\IsCompressed
    "File is not compressed, '%type%' detected" => "Il file non &egrave; un file compresso, ma un file di tipo '%type%'",
    "The mimetype could not be detected from the file" => "Il mimetype del file non può essere rilevato",
    "File is not readable or does not exist" => "Il file non &egrave; leggibile o non esiste",

    // Zend\Validator\File\IsImage
    "File is no image, '%type%' detected" => "Il file non &egrave; un'immagine, ma un file di tipo '%type%'",
    "The mimetype could not be detected from the file" => "Il mimetype del file non può essere rilevato",
    "File is not readable or does not exist" => "Il file non &egrave; leggibile o non esiste",
    ...
    "Maximum allowed size for file is '%max%' but '%size%' detected" => "La dimensione massima consentita per il file &egrave; '%max%' ma &egrave; stata rilevata una dimensione di '%size%'",
    "Minimum expected size for file is '%min%' but '%size%' detected" => "La dimensione minima consentita per il file &egrave; '%min%' ma &egrave; stata rilevata una dimensione di '%size%'",
    "File is not readable or does not exist" => "Il file non &egrave; leggibile o non esiste",
    ...
    "File '%value%' was only partially uploaded" => "Il file '%value%' &egrave; stato caricato solo parzialmente",
    "File '%value%' was not uploaded" => "Il file '%value%' non &egrave; stato caricato",
    "No temporary directory was found for file '%value%'" => "Non &egrave; stata trovata una directory temporanea per il file '%value%'",
    ...
    "File '%value%' was illegally uploaded. This could be a possible attack" => "Il file '%value%' &egrave; stato caricato irregolarmente. Potrebbe trattarsi di un attacco",
    "File '%value%' was not found" => "Il file '%value%' non &egrave; stato trovato",
    ...
    "File was only partially uploaded" => "Il file &egrave; stato caricato solo parzialmente",
    "File was not uploaded" => "Il file non &egrave; stato caricato",
    "No temporary directory was found for file" => "Non &egrave; stata trovata una directory temporanea per il file",
    ...
    "File was illegally uploaded. This could be a possible attack" => "Il file &egrave; stato caricato irregolarmente. Potrebbe trattarsi di un attacco",
    "File was not found" => "Il file non &egrave; stato trovato",
    ...
    "The input is not greater than '%min%'" => "L'input non &egrave; maggiore di '%min%'",
    "The input is not greater or equal than '%min%'" => "L'input non &egrave; maggiore o uguale a '%min%'",

    // Zend\Validator\Hex
    "Invalid type given. String expected" => "Tipo di dato non valido. Era attesto un dato di tipo string",
    "The input contains non-hexadecimal characters" => "L'input non &egrave; composto solo da caratteri esadecimali",
    ...
    "The input appears to be a DNS hostname but cannot extract TLD part" => "L'input sembra essere un hostname DNS ma non &egrave; possibile estrarne il TLD",
    "The input appears to be a DNS hostname but cannot match TLD against known list" => "L'input sembra essere un hostname DNS ma il suo TLD &egrave; sconosciuto",
    ...
    "No token was provided to match against" => "Non &egrave; stato dato nessun token per il confronto",

    // Zend\Validator\InArray
    "The input was not found in the haystack" => "L'input non &egrave; stato trovato nell'array",
    ...
    "The input is not an instance of '%className%'" => "L'input non &egrave; un'istanza di '%className%'",

    // Zend\Validator\Isbn
    "Invalid type given. String or integer expected" => "Tipo di dato non valido. Era atteso un dato di tipo string o integer",
    "The input is not a valid ISBN number" => "L'input non &egrave; un numero ISBN valido",

    // Zend\Validator\LessThan
    "The input is not less than '%max%'" => "L'input non &egrave; minore di '%max%'",
    "The input is not less or equal than '%max%'" => "L'input non &egrave; minore o uguale a '%max%'",

    // Zend\Validator\NotEmpty
    "Value is required and can't be empty" => "Il dato &egrave; richiesto e non può essere vuoto",
    ...
    "There was an internal error while using the pattern '%pattern%'" => "Si &egrave; verificato un errore interno usando il pattern '%pattern%'",

    // Zend\Validator\Sitemap\Changefreq
    "The input is not a valid sitemap changefreq" => "L'input non &egrave; una sitemap changefreq valida",
    "Invalid type given. String expected" => "Tipo di dato non valido. Era attesto un dato di tipo string",

    // Zend\Validator\Sitemap\Lastmod
    "The input is not a valid sitemap lastmod" => "L'input non &egrave; un sitemap lastmod valido",
    "Invalid type given. String expected" => "Tipo di dato non valido. Era attesto un dato di tipo string",

    // Zend\Validator\Sitemap\Loc
    "The input is not a valid sitemap location" => "L'input non &egrave; una sitemap location valida",
    "Invalid type given. String expected"       => "Tipo di dato non valido. Era attesto un dato di tipo string",

    // Zend\Validator\Sitemap\Priority
    "The input is not a valid sitemap priority"                     => "L'input non &egrave; una sitemap priority valida",
    ...
    "Invalid type given. String expected"           => "Tipo di dato non valido. Era attesto un dato di tipo string",
    "The input is less than %min% characters long"  => "L'input &egrave; meno lungo di %min% caratteri",
    "The input is more than %max% characters long"  => "Il dato &egrave; pi&ugrave; lungo di %max% caratteri e\o contiene caratteri speciali",

    "The input is more than 10 characters long" => "L'input &egrave; pi&ugrave; lungo di 10 caratteri",
