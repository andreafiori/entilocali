...
/**
 * Modalita Assegnazione Update into db, log, show result message
 */
class ModalitaAssegnazioneUpdateController extends SetupAbstractController
{
    public function indexAction()
    {
        ...
        try {
            ...
            $logWriter->writeLog(array(
                ...
                'message'       => "Aggiornata modalita assegnazione ".$inputFilter->nome,
                'type'          => 'info',
            ...
            $this->layout()->setVariables(array(
                'messageType'           => 'success',
                'messageTitle'          => 'Modalita assegnazione aggiornata correttamente',
                'messageText'           => 'I dati sono stati processati correttamente dal sistema',
                'messageShowFormLink'   => 1,
                'messageShowForm'       => 'Torna alla modalita assegnazione',
            ...
            $logWriter->writeLog(array(
                ...
                'message'       => "Errore aggiornamento modalita assegnazione atti concessione",
                'type'          => 'error',
            ...
            $this->layout()->setVariables(array(
                'messageType'           => 'danger',
                'messageTitle'          => 'Errore aggiornamento modalita assegnazione atti concessione',
                'messageText'           => $e->getMessage(),
                'form'                  => $form,
                'formInputFilter'       => $inputFilter->getInputFilter(),
                'messageShowFormLink'   => 1,
                'messageShowForm'       => 'Torna alle modalita assegnazione',
            ));
