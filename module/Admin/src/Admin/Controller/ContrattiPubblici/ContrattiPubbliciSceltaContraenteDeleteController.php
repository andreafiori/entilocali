...
/**
 * TODO: delete voce scelta, delete or reset contratti pubblici association
 */
class ContrattiPubbliciSceltaContraenteDeleteController extends SetupAbstractController
{
    public function indexAction()
    {
        ...
        try {
            ...
            $this->layout()->setVariables(array(
                'messageType'           => 'danger',
                'messageTitle'          => 'Errore inserimento nuova voce scelta contraente',
