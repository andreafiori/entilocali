...
class AlboPretorioSezioniCrudHandler extends CrudHandlerAbstract implements CrudHandlerInterface, CrudHandlerInsertUpdateInterface
{
    ...
    public function logInsertOk()
    {
        ...
        return $LogWriter->writeLog(array(
            ...
            'message'   => "Inserito l'atto albo pretorio ".$inputFilter->nome,
            'type'      => 'error',
            'backend'   => 1,
        ));
    }
    ...
    public function logInsertKo($message = null)
    {
        ...
        return $LogWriter->writeLog(array(
            'user_id'   => $userDetails->id,
            'module_id' => $this->moduleId,
            'message'   => "Errore nell'inserimento sezione albo pretorio ".$inputFilter->nome.' Messaggio: '.$message,
            'type'      => 'error',
            'backend'   => 1,
        ));
    }
    ...
    public function logUpdateOk()
    {
        ...
        return $LogWriter->writeLog(array(
            'user_id'   => $userDetails->id,
            'module_id' => $this->moduleId,
            'message'   => "Aggiornata la sezione albo pretorio ".$inputFilter->nome,
            'type'      => 'info',
            'backend'   => 1,
        ));
    }
    ...
    public function logUpdateKo($message = null)
    {
        ...
        return $LogWriter->writeLog(array(
            'user_id'   => $userDetails->id,
            'module_id' => $this->moduleId,
            'message'   => "Errore nell'aggiornamento dell'atto albo pretorio ".$inputFilter->nome.' Messaggio: '.$message,
            'type'      => 'error',
            'backend'   => 1,
        ));
    }
