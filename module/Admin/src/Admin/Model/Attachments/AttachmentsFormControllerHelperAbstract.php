...
abstract class AttachmentsFormControllerHelperAbstract
{
    ...
    protected $classMap = array(
        'albo-pretorio'                 => '\Admin\Model\AlboPretorio\AlboPretorioAttachmentsPropertiesGetter',
        'stato-civile'                  => '\Admin\Model\StatoCivile\StatoCivileAttachmentsPropertiesGetter',
        'atti-concessione'              => '\Admin\Model\AttiConcessione\AttiConcessioneAttachmentsPropertiesGetter',
        'contratti-pubblici'            => '\Admin\Model\ContrattiPubblici\ContrattiPubbliciAttachmentsPropertiesGetter',
        'contenuti'                     => '\Admin\Model\Contenuti\ContenutiAttachmentsPropertiesGetter',
        'amministrazione-trasparente'   => '\Admin\Model\AmministrazioneTrasparente\AmministrazioneTrasparenteAttachmentsPropertiesGetter',
        'blogs'                         => '\Admin\Model\Blogs\BlogsAttachmentsPropertiesGetter'
    );
