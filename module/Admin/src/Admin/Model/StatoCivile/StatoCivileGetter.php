...
class StatoCivileGetter extends QueryBuilderHelperAbstract
{
    ...
    {
        $this->setSelectQueryFields("DISTINCT(sca.id) AS id, sca.titolo, sca.progressivo, sca.anno, sca.data, scs.id AS sezioneId, sca.scadenza, scs.nome, ( SELECT CONCAT(u.name, ' ', u.surname) FROM Application\Entity\ZfcmsUsers u WHERE u.id = sca.utente ) AS user_name_surname ");
