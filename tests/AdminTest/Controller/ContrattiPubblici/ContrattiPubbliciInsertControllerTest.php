...
use Admin\Controller\ContrattiPubblici\ContrattiPubbliciInsertController;
...
class ContrattiPubbliciInsertControllerTest extends InsertUpdateTestSuite
{
    /**
     * @var ContrattiPubbliciInsertController
     */
